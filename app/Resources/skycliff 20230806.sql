...
--
-- Host: localhost:8889
-- Generation Time: Aug 06, 2023 at 07:53 PM
...
(2, 'Boekes', 'Chadder', 'Physician', 'CRFP', 'chad@aol.com', '199999999'),
(3, 'tome', 'Leah', 'Family', 'Wife', 'leah@tome.net', '30388888'),
(6, 'Tome', 'Luer', 'giver', 'homehealth', 'luke@tome.net', '8886664444'),
(7, 'Tome', 'Barbara', 'family', 'home', 'barb@tome.net', '8887778888'),
(8, 'onemore', 'time', 'friend', 'Centura health', 'friend@aol.com', '8787676566');
...
INSERT INTO `participants` (`id`, `last_name`, `first_name`, `street_address_1`, `responsible_party`, `phone`) VALUES
