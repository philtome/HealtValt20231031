...
--
-- Host: localhost:8889
-- Generation Time: Sep 02, 2023 at 05:49 AM
...
CREATE TABLE `care_plans` (
  ...
  `presentHealth` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `assistiveDevices` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
