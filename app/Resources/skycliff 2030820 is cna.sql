...
--
-- Host: localhost:8889
-- Generation Time: Aug 20, 2023 at 08:51 PM
...
INSERT INTO `contacts` (`id`, `last_name`, `first_name`, `contact_type`, `company_practice`, `email`, `phone`, `is_driver`, `is_employee`, `is_caregiver`, `is_cna`, `is_rn`) VALUES
(1, 'Tome', 'Philip', 'Family', 'Self', 'phil@tome.net', '3038591164', 0, 0, 0, 0, 0),
(9, 'contact4', 'contact4', 'some type', ';lkj;ljk;lj;', 'email@email.com', '878787', 0, 0, 0, 0, 0),
(14, 'contact3', 'Contacdt3', 'kksdks', ';alkj;alksdfjal;kjfd ;alsdkjfa ;sdlfkjad s;flaksjdf a;lkj', 'phil@tome.net', '878888', 0, 0, 0, 0, 0),
(15, 'another', 'contact', 'some time', '', '007@tomel.net', '888', 0, 0, 0, 0, 0),
(16, 'contact5', 'Contacdt5', 'kksdks', ';alkj;alksdfjal;k', 'phil@tome.net', '878888', 0, 0, 0, 0, 0),
(17, 'Driver', 'John', 'kksdks', 'Driver John', 'phil@tome.net', '878888', 1, 1, 0, 0, 1),
(18, 'another', 'contact', 'some time', '', '007@tomel.net', '888', 0, 0, 0, 0, 0),
(20, 'another', 'contact', 'some time', '', '007@tomel.net', '888', 0, 0, 0, 0, 0),
(22, 'another', 'contact', 'some time', '', '007@tomel.net', '888', 0, 0, 0, 0, 0),
(23, 'Smith', 'Philipppppppp', 'Family', 'Self', 'phil@gmail.com', '3038591164', 1, 0, 0, 0, 0),
(24, 'Simpson', 'Bart', 'Family', 'Self', 'phil@tome.net', '3038591164', 1, 0, 0, 0, 0);
