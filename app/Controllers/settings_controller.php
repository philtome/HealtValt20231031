...
class settings_controller extends abstract_controller
{
    ...
    public function movePostDataToFields($dataToSave,$em = null)
    {
        ...
        $dataToSave->setVisitDesc(isset($_POST['doc1desc']) ? filter_var($_POST['doc1desc'], FILTER_SANITIZE_SPECIAL_CHARS) : null);
        $dataToSave->setPatientDesc(isset($_POST['doc2desc']) ? filter_var($_POST['doc2desc'], FILTER_SANITIZE_SPECIAL_CHARS) : null);
